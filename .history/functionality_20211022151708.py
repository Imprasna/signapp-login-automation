...
if platform.system() == 'Windows': 
    ...
    x=datetime.today()
    y=x.replace(day=x.day+0, hour=15, minute=18, second=0, microsecond=0)
    print ("hello world")

    exec_date = date(2021, 22, 10)

    # Store the job in a variable in case we want to cancel it
    job = sched.add_date_job(login_automate, exec_date, ['text'])

    # The job will be executed on November 6th, 2009 at 16:30:05
    job = sched.add_date_job(login_automate, datetime(2021, 22, 10, 15, 18, 5), ['text'])
